...
ad.id = "address"
ad.placeholder="address"

var add2 = createele("label", "Address Line 2", "address2")
var add22 = document.createElement("textarea")
add22.id = "addresss1"
add22.placeholder="address"

var pin = createele("label", "PIN", "pincodee")
var pinn = document.createElement("input")
pinn.type = "text,number"
pinn.required=true
pinn.id = "pincode"
pinn.placeholder="pincode"
...
divform.append(h1, le, br, fn, br1, lname, br2, ln, br3, add, br4, ad, br5, add2, br6, add22, br7, pin, br8, pinn, br10, gender, br9, r1, r, r2, r22, r3, r33, br11, p1,
    chk, l, br12, chk1, l2, br13, chk2, l3, br14, chk3, l4, br15, chk4, l5,
    br16, state, br17, state1, br18, country, br19, country1, br20,button)
form.append(divform)
...
function vali() {
    ...
    // var letters = '/^[a-zA-Z]+$/';
    if ((n == parseInt(n) || n == e)) {
        alert("fill all the details or you must have entered wrong value")
    }
